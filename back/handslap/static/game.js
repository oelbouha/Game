...
class game {
	...
	setPlayerOneHand(hand) {
		console.log("setPlayerOneHand")
		this.playerOneHand = hand;
	}
	
	setPlayerTwoHand(hand) {
		console.log("setPlayerTwoHand")
	...
	waitForImagesToLoad() {
		console.log("waitForImagesToLoad")
		let loadedImages = 0;
	...
	drawAll() {
		...
		// this.context.arc(10, this.playerOne.hand.getInitialY(), 50, 0, Math.PI * 2);
		// this.context.fillStyle = "red";
		// this.context.fill();

		// console.log(`one: ${this.playerOne.hand.getInitialY()} ----- two: ${this.playerTwo.hand.getInitialY()}`)


		// this.context.beginPath();
		// this.context.arc(100, this.playerTwo.hand.getInitialY(), 50, 0, Math.PI * 2);
		// this.context.fillStyle = "red";
		// this.context.fill();
